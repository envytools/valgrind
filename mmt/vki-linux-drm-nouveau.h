...
#define VKI_DRM_IOCTL_NOUVEAU_GETPARAM			VKI_DRM_IOWR(VKI_DRM_NOUVEAU_GETPARAM, struct vki_drm_nouveau_getparam)
#define VKI_DRM_IOCTL_NOUVEAU_SETPARAM			VKI_DRM_IOWR(VKI_DRM_NOUVEAU_SETPARAM, struct vki_drm_nouveau_setparam)
#define VKI_DRM_IOCTL_NOUVEAU_CHANNEL_ALLOC		VKI_DRM_IOWR(VKI_DRM_NOUVEAU_CHANNEL_ALLOC, struct vki_drm_nouveau_channel_alloc)
#define VKI_DRM_IOCTL_NOUVEAU_CHANNEL_FREE		VKI_DRM_IOW (VKI_DRM_NOUVEAU_CHANNEL_FREE, struct vki_drm_nouveau_channel_free)
#define VKI_DRM_IOCTL_NOUVEAU_GROBJ_ALLOC		VKI_DRM_IOW (VKI_DRM_NOUVEAU_GROBJ_ALLOC, struct vki_drm_nouveau_grobj_alloc)
#define VKI_DRM_IOCTL_NOUVEAU_NOTIFIEROBJ_ALLOC		VKI_DRM_IOWR(VKI_DRM_NOUVEAU_NOTIFIEROBJ_ALLOC, struct vki_drm_nouveau_notifierobj_alloc)
#define VKI_DRM_IOCTL_NOUVEAU_GPUOBJ_FREE		VKI_DRM_IOW (VKI_DRM_NOUVEAU_GPUOBJ_FREE, struct vki_drm_nouveau_gpuobj_free)
#define VKI_DRM_IOCTL_NOUVEAU_GEM_NEW			VKI_DRM_IOWR(VKI_DRM_NOUVEAU_GEM_NEW, struct vki_drm_nouveau_gem_new)
#define VKI_DRM_IOCTL_NOUVEAU_GEM_PUSHBUF		VKI_DRM_IOWR(VKI_DRM_NOUVEAU_GEM_PUSHBUF, struct vki_drm_nouveau_gem_pushbuf)
#define VKI_DRM_IOCTL_NOUVEAU_GEM_CPU_PREP		VKI_DRM_IOW (VKI_DRM_NOUVEAU_GEM_CPU_PREP, struct vki_drm_nouveau_gem_cpu_prep)
#define VKI_DRM_IOCTL_NOUVEAU_GEM_CPU_FINI		VKI_DRM_IOW (VKI_DRM_NOUVEAU_GEM_CPU_FINI, struct vki_drm_nouveau_gem_cpu_fini)
#define VKI_DRM_IOCTL_NOUVEAU_GEM_INFO			VKI_DRM_IOWR(VKI_DRM_NOUVEAU_GEM_INFO, struct vki_drm_nouveau_gem_info)
